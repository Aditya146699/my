...
export const SignInCard = () => {
  ...
  return (
    <Card className="bg-primary size-full border-none shadow-none md:w-[487px]">
      ...
      <CardContent className="p-7">
        <Form {...signInForm}>
          <form onSubmit={signInForm.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" disabled={isPending} size="lg" className="btn btn-primary w-full">
              Login
            </Button>
          </form>
        </Form>
      ...
      <CardContent className=" flex flex-col gap-y-4 p-7">
        <Button onClick={() => handleOAuth(OAuthProvider.Google)} disabled={isPending} variant="secondary" size="lg" className="btn btn-primary w-full">

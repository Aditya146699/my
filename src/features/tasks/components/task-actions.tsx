  ...
  return (
    <div className="flex justify-end">
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end" className="w-48  bg-black opacity-90">
          <DropdownMenuItem onClick={onOpenTask} disabled={isPending} className="p-[10px] font-medium text-gray-500">
            <ExternalLink className="mr-2 size-4 stroke-2" />
            Task Details
          </DropdownMenuItem>

          <DropdownMenuItem onClick={onOpenProject} disabled={isPending} className="p-[10px] font-medium text-gray-500">
            <ExternalLink className="mr-2 size-4 stroke-2" />
            Open Project
          </DropdownMenuItem>

          <DropdownMenuItem onClick={() => open(id)} disabled={isPending} className="p-[10px] font-medium  text-gray-500">
